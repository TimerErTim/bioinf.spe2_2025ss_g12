...
#risk-entries(
  ...
  (
    ...
    description: "Instabile Konstruktion des Greifarms beeinträchtigt die Fähigkeit, Steine aufzuheben, erheblich",
    probability: 5,
    impact: 8,
  ...
  (
    ...
    description: "Es tritt ein Ereignis auf, für das keine Fehlerbehandlung möglich ist",
    probability: 5,
    impact: 6,
    recording-date: datetime(year: 2025, month: 03, day: 31),
    potential-treatment: [
  ...
  (
    title: "Zeitdruck",
    description: "Zu wenig Zeit um die aktuell geltenden Anforderungen bis zum Meilensteintag umzusetzen könnte die Fertigstellung/Qualität des Projekts gefährden",
    probability: 7,
    impact: 5,
    recording-date: datetime(year: 2025, month: 03, day: 31),
    potential-treatment: [
