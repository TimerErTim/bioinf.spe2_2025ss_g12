...
#set page(
  ...
  footer: [
    ...
    #grid(
        columns: (1fr, auto),
        align(left)[
            Gruppe 12, Version 1.2 \
            *Author*: Tim Peko, *Korrekturleser*: Moritz Kieselbach
        ],
        align(right)[
            #context[
...
#align(center)[
  #text(17pt)[
    = Programmiersprachen für LEGO Mindstorms EV3 – Vergleich & Entscheidung
  ]
]
